...
export const api = {
  ...
  /** Удалить свою истёкшую доп. подписку (secondary). Root-подписку удалить нельзя. */
  async clientDeleteSecondarySubscription(token: string, id: string): Promise<{ success: boolean; message?: string }> {
