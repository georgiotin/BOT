...
import {
  Box, LayoutDashboard, Users, CreditCard, Settings, LogOut, KeyRound,
...
function useNavSections(): NavItem[] {
  ...
  return [
    ...
    { to: "/admin/antibot", label: "Антибот", icon: Box, section: "antibot", category: "settings" },
            ...
            >
              <div className="flex h-16 items-center justify-center px-4 relative z-10">
                ...
                <div className="flex items-center gap-3 min-w-0">
                  {brand.logo ? <img src={brand.logo} alt="" className="h-8 w-auto object-contain" /> : <Box className="h-6 w-6 text-primary shrink-0" />}
                  {brand.serviceName ? <span className="font-bold text-[14.5px] tracking-wide truncate">{brand.serviceName}</span> : null}
                </div>
