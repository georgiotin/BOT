...
const VARIANT_STYLES: Record<Variant, string> = {
  primary:
    "bg-gradient-to-b from-saccent-500 via-saccent-600 to-saccent-600 text-white font-semibold " +
    "shadow-[0_0_32px_-4px_rgb(var(--stealth-accent)_/_0.55),0_10px_28px_-8px_rgb(var(--stealth-accent)_/_0.65),inset_0_1px_0_rgba(255,255,255,0.25)] " +
    "hover:-translate-y-0.5 hover:shadow-[0_0_44px_-4px_rgb(var(--stealth-accent)_/_0.7),0_14px_34px_-8px_rgb(var(--stealth-accent)_/_0.75),inset_0_1px_0_rgba(255,255,255,0.3)] " +
  ...
  ghost:
    ...
    "hover:bg-white/[0.08] hover:border-white/15 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.1),0_8px_24px_-12px_rgb(var(--stealth-accent)_/_0.25)] " +
    "active:scale-[0.98]",
  highlight:
    "bg-zinc-900/70 text-white font-semibold border border-saccent-500/40 backdrop-blur-xl " +
    "shadow-[0_0_28px_-4px_rgb(var(--stealth-accent)_/_0.3),inset_0_0_20px_rgb(var(--stealth-accent)_/_0.06),inset_0_1px_0_rgba(255,255,255,0.08)] " +
    "hover:border-saccent-500/60 hover:shadow-[0_0_40px_-4px_rgb(var(--stealth-accent)_/_0.5),inset_0_0_24px_rgb(var(--stealth-accent)_/_0.1)] active:scale-[0.98]",
};
