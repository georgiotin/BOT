...
import { Zap, Settings2, Smartphone, Gift, Users, ChevronRight, Box, Calendar, Clock, Plus, Check, Layers, Sparkles } from "lucide-react";
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between gap-2 pt-0.5">
                      ...
                      >
                        <span
                          className={cn(
                            // T-fix-toggle (2026-08-13): раньше не было явного left —
                            // позиция кружка зависела от того, как конкретный браузер/
                            // вебвью считает "auto" для абсолютного позиционирования без
                            // left. В Telegram WebView это иногда давало кружок справа
                            // даже в выключенном состоянии. Теперь left зафиксирован явно,
                            // а translate-x только двигает кружок вправо при включении.
