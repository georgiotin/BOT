...
import { Zap, Globe, Box, Lock, LayoutDashboard, Sparkles, type LucideIcon } from "lucide-react";
import { txt, arr, SECTION_SCROLL_OFFSET, useLandingTheme } from "../utils";
import type { LandingApiBlock } from "../types";

const ICONS: LucideIcon[] = [Zap, Globe, Box, Lock, LayoutDashboard, Sparkles];
