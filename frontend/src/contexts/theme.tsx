...
export const ACCENT_PALETTES: Record<ThemeAccent, AccentPalette> = {
  ...
  red: { label: "Красная", swatch: "#3b82f6", light: { "--primary": "0 84.2% 60.2%", "--primary-foreground": "0 0% 100%", "--ring": "0 84.2% 60.2%" }, dark: { "--primary": "0 72.2% 50.6%", "--primary-foreground": "0 0% 100%", "--ring": "0 72.2% 50.6%" } },
