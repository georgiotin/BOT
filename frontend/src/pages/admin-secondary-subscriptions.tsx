                        ...
                        <div className="bg-foreground/[0.03] dark:bg-white/[0.04] border border-border rounded-xl p-4">
                          ...
                          <span className={cn(
                            ...
                            statusActive
                              ...
                              : "bg-blue-500/15 text-blue-500 dark:text-blue-400 border border-blue-500/20 shadow-sm"
                          )}>
                            {statusStr}
                          </span>
                        </div>
      ...
      <Dialog open={editOpen} onOpenChange={(o) => !o && !editSaving && setEditOpen(false)}>
        <DialogContent className="sm:max-w-md bg-card border-border p-4 sm:rounded-2xl">
          ...
          <div className="space-y-4 mt-4">
            ...
            {editError && (
              <div className="rounded-xl border border-blue-500/30 bg-blue-500/10 text-blue-300 text-xs p-3">
                 {editError}
              </div>
            )}
          ...
          <div className="p-4 relative z-10">
            {createResult ? (
              ...
              <div className="space-y-6">
                ...
                {createError && (
                  <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/30 text-sm text-blue-400 font-medium flex items-center gap-3">
