...
function statusColors(status: string): string {
  // T-fix-status-monotone (2026-08-13): раньше "Открыт"/"На рассмотрении" были
  // зелёным/жёлтым — единственные цветные пятна на однотонном
  // красно-серо-белом экране. Теперь статус закрашен акцентным цветом темы
  // (тот же --stealth-accent, что и остальной UI), а не своим отдельным цветом.
