                ...
                <tr key={t.id} className="border-t border-border hover:bg-foreground/5 transition-colors">
                  ...
                  <td className="px-5 py-3.5 text-right">
                    <div className="flex justify-end gap-1">
                      ...
                      <Button size="icon" variant="ghost" onClick={() => handleDelete(t.id)} className="h-8 w-8 rounded-lg text-blue-500 dark:text-blue-400 hover:bg-blue-500/10" title="Удалить">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4" onClick={onClose}>
      <Card className="w-full max-w-lg max-h-[90vh] overflow-y-auto bg-card border-border rounded-2xl p-4 space-y-4" onClick={(e) => e.stopPropagation()}>
        ...
        {err && (
          <div className="rounded-xl border border-blue-500/30 bg-blue-500/10 px-3 py-2 text-xs text-blue-500 dark:text-blue-400">
            {err}
          </div>
        )}
