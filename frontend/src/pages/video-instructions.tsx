            ...
            <Card className="group flex items-center gap-3 bg-card border-border rounded-xl p-3 hover:border-border transition-all">
              ...
              {editingId !== item.id && (
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <Button variant="ghost" size="icon" className="h-8 w-8 rounded-lg text-blue-500 dark:text-blue-400 hover:bg-blue-500/10" onClick={() => deleteItem(item.id)} title="Удалить">
