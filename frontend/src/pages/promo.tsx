              ...
              <Card className="bg-card border-border rounded-2xl p-4">
                <div className="flex items-center justify-between gap-4 flex-wrap">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    ...
                    <Button variant="ghost" size="icon" className="h-8 w-8 rounded-lg text-blue-500 dark:text-blue-400 hover:bg-blue-500/10" title="Удалить" onClick={() => handleDelete(g.id)}>
