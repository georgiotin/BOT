            ...
            {!detailId ? (
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button variant="outline" size="sm" className="gap-1.5 rounded-xl border-blue-500/30 text-blue-500 dark:text-blue-400 hover:bg-blue-500/10 hover:border-blue-500/50" onClick={() => setNodeToDelete({ ...detailNode, slotsCount: detailNode.slots.length, hasCustomConfig: !!detailNode.customConfigJson } as SingboxNodeListItem)}>
                ...
                {categories.map((c, i) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      ...
                      <Button variant="outline" size="icon" className="h-8 w-8 rounded-lg border-blue-500/30 text-blue-500 dark:text-blue-400 hover:bg-blue-500/10 hover:border-blue-500/50" onClick={() => handleDeleteCategory(c.id)}>
                        ...
                        {cat.tariffs.map((t) => (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                              ...
                              <Button variant="outline" size="icon" className="h-8 w-8 rounded-lg border-blue-500/30 text-blue-500 dark:text-blue-400 hover:bg-blue-500/10 hover:border-blue-500/50" onClick={() => handleDeleteTariff(t.id)}>
                                <Trash2 className="h-3.5 w-3.5" />
                              </Button>
                            </div>
                          </motion.li>
