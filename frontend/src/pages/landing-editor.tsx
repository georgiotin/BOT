    ...
    <div className="min-h-screen bg-background">
        ...
        <div
          className={`fixed top-4 right-4 z-50 flex items-center gap-2 rounded-xl border px-4 py-3 text-sm ${
            toast.kind === "ok"
              ...
              : "border-blue-500/30 bg-blue-50 text-blue-900 dark:bg-blue-950/50 dark:text-blue-100"
          }`}
        >
      ...
      <div className="container mx-auto px-4 py-6">
        {loading ? (
          ...
          <div className="rounded-xl border border-blue-500/30 bg-blue-50 p-4 text-sm text-blue-900 dark:bg-blue-950/50 dark:text-blue-100">
    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button onClick={onDelete} variant="outline" size="sm" className="gap-1.5 text-blue-600 hover:text-blue-700">
        ...
        <TabsContent value="json" className="mt-5 space-y-4">
          <div>
            <div className="flex items-center justify-between">
              ...
              {propsError ? <span className="text-xs text-blue-500">{propsError}</span> : null}
            </div>
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              {i18nError ? <span className="text-xs text-blue-500">{i18nError}</span> : null}
            </div>
            ...
            {snapshots.map((s) => (
              <div key={s.id} className="flex items-center justify-between gap-3 rounded-lg border border-border p-3">
                ...
                <div className="flex shrink-0 gap-2">
                  ...
                  <Button onClick={() => handleDelete(s.id)} size="sm" variant="outline" className="gap-1.5 text-blue-600 hover:text-blue-700">
                    <Trash2 className="h-3.5 w-3.5" />
                  </Button>
                </div>
              </div>
