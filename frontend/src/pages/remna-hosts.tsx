    ...
    <div className="flex flex-col gap-3.5 relative">
      ...
      {selected.size > 0 && (
        ...
        >
          ...
          <Button variant="outline" size="sm" className="rounded-lg gap-1.5 text-blue-500 dark:text-blue-400 hover:bg-blue-500/10" disabled={bulkBusy} onClick={() => bulkAction("delete")}>
              ...
              <Card className={cn("bg-card border-border rounded-2xl p-4 transition-colors", selected.has(h.uuid) && "ring-1 ring-primary/40 border-border")}>
                <div className="flex items-center justify-between gap-4 flex-wrap">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    ...
                    <Button variant="ghost" size="icon" className="h-8 w-8 rounded-lg text-blue-500 dark:text-blue-400 hover:bg-blue-500/10" title="Удалить" disabled={busy === h.uuid} onClick={() => handleDelete(h)}>
