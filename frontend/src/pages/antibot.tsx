    ...
    <div className="flex flex-col gap-3.5 relative">
      ...
      {error && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="rounded-xl border border-blue-500/30 bg-blue-500/10 px-4 py-3 text-sm text-blue-500 flex items-center gap-2"
        >
...
function CandidateRow({
  ...
  return (
    ...
    >
      <input type="checkbox" checked={selected} onChange={onToggle} className="accent-blue-500" />
