...
const STATUS_META = {
  ...
  error: { cls: "text-blue-600 dark:text-blue-400 bg-blue-500/10 border-blue-500/30", icon: XCircle, label: "ERROR" },
  ...
  return (
    <div className="flex flex-col gap-3.5 relative">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between !bg-transparent !border-0 ! !shadow-none">
        ...
        <Button onClick={handleLogoutAll} variant="outline" size="sm" className="gap-1.5 rounded-xl text-blue-600 dark:text-blue-400 border-blue-500/30 hover:bg-blue-500/10">
      ...
      {error ? <div className="rounded-xl border border-blue-500/30 bg-blue-500/10 px-4 py-3 text-sm text-blue-500 dark:text-blue-400">{error}</div> : null}
                      ...
                      {lastRun ? (
                        <div className="mt-0.5 text-[11px] flex items-center gap-2">
                          {lastRun.ok ? (
                            ...
                            <span className="text-blue-600 dark:text-blue-400 inline-flex items-center gap-1"><XCircle className="h-3 w-3" /> ERROR</span>
                          )}
