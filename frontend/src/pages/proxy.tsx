                      ...
                      <tr key={n.id} className="border-b border-border last:border-0 hover:bg-foreground/[0.03] dark:hover:bg-white/[0.02] transition-colors">
                        ...
                        <td className="py-3 px-3 text-right">
                          <div className="flex justify-end gap-1">
                            ...
                            <Button variant="ghost" size="icon" className="h-8 w-8 rounded-lg text-blue-500 dark:text-blue-400 hover:bg-blue-500/10" onClick={() => setNodeToDelete(n)} title="Удалить">
                    ...
                    <tr key={s.id} className="border-b border-border last:border-0 hover:bg-foreground/[0.03] dark:hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="py-3 px-3">
                        <span className={cn(
                          ...
                          s.status === "REVOKED" && "bg-blue-500/10 text-blue-500 dark:text-blue-400 border-blue-500/20",
                      ...
                      <td className="py-3 px-3 text-right">
                        <div className="flex justify-end gap-1">
                          ...
                          <Button variant="ghost" size="icon" className="h-8 w-8 rounded-lg text-blue-500 dark:text-blue-400 hover:bg-blue-500/10" onClick={() => handleDeleteSlot(s.id)} title="Удалить">
                            <Trash2 className="h-3.5 w-3.5" />
                          </Button>
                        </div>
                      </td>
              ...
              <Card key={cat.id} className="bg-card border-border rounded-2xl overflow-hidden">
                <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-4 border-b border-border bg-foreground/[0.02] dark:bg-white/[0.02]">
                  ...
                  <div className="flex gap-2 flex-wrap shrink-0">
                    ...
                    <Button variant="outline" size="sm" className="gap-1.5 rounded-xl border-blue-500/30 text-blue-500 dark:text-blue-400 hover:bg-blue-500/10 hover:border-blue-500/50" onClick={() => handleDeleteCategory(cat.id)}>
                      ...
                      {cat.tariffs.map((t) => (
                        ...
                        >
                          ...
                          <div className="flex gap-1 shrink-0">
                            ...
                            <Button variant="ghost" size="icon" className="h-8 w-8 rounded-lg text-blue-500 dark:text-blue-400 hover:bg-blue-500/10" onClick={() => handleDeleteTariff(t.id)}>
                              <Trash2 className="h-3.5 w-3.5" />
                            </Button>
                          </div>
                        </motion.li>
