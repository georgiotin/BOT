...
const COLORS = ["#6366f1", "#22c55e", "#f59e0b", "#3b82f6", "#8b5cf6", "#06b6d4", "#ec4899", "#14b8a6", "#f97316", "#84cc16"];
    ...
    return (
      <div className="px-4 sm:px-6 md:px-8 pt-6 pb-10">
        <Card className="bg-card border-border rounded-2xl p-8 text-center">
          <p className="text-sm text-blue-500 dark:text-blue-400">Ошибка загрузки аналитики</p>
        </Card>
      </div>
    );
  }
