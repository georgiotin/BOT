        ...
        {!singleAttachment ? (
          ...
          >
            ...
            <button
              ...
              className="h-8 w-8 rounded-lg bg-blue-500/10 text-blue-500 hover:bg-blue-500/20 flex items-center justify-center transition"
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-2 mb-2">
                        ...
                        {(broadcastResult.failedTelegram + broadcastResult.failedEmail) > 0 && (
                          <span className="inline-flex items-center gap-1 text-xs bg-blue-500/15 text-blue-600 dark:text-blue-400 border border-blue-500/30 px-2.5 py-1 rounded-lg">
                    ...
                    {listJob && (
                      ...
                      >
                        ...
                        <div className="flex flex-wrap gap-2 text-xs">
                          ...
                          {listJob.failed > 0 && (
                            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/30">
                          ...
                          <details className="text-xs">
                            ...
                            <div className="mt-2 max-h-40 overflow-auto space-y-1 rounded-xl bg-card p-2 font-mono">
                              {listJob.errors.map((er, i) => (
                                <div key={i} className="text-blue-500/90"><span className="text-muted-foreground">{er.telegramId}:</span> {er.error}</div>
                              ))}
                            </div>
                          </details>
                        )}
...
function statusBadge(status: BroadcastHistoryItem["status"]): { text: string; cls: string; dot: string } {
  ...
  return { text: "Ошибка", cls: "bg-blue-500/15 text-blue-600 dark:text-blue-400 border-blue-500/30", dot: "bg-blue-500" };
}
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <HistoryStatCard icon={AlertTriangle} label="Ошибок доставки" value={stats.totalFailed} colorClass="bg-muted border-blue-500/30 text-blue-500 dark:text-blue-400" />
      </div>
        ...
        <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto rounded-2xl">
          ...
          {detail && (
            <div className="space-y-4 text-sm">
              ...
              {detail.error && (
                <div className="p-4 rounded-xl border border-blue-500/30 bg-blue-500/10 text-blue-600 dark:text-blue-400 text-xs flex gap-2">
              ...
              {detail.errors && detail.errors.length > 0 && (
                <div>
                  ...
                  <pre className="whitespace-pre-wrap text-xs p-3 rounded-xl border bg-blue-500/5 border-blue-500/20 max-h-48 overflow-y-auto text-blue-600 dark:text-blue-400">{detail.errors.join("\n")}</pre>
                </div>
              )}
              ...
              {detail.status === "running" && (
                <div className="p-4 rounded-xl border border-blue-500/30 bg-blue-500/[0.05] space-y-3">
                  <div className="flex items-center gap-2">
                    <AlertTriangle className="h-4 w-4 text-blue-500" />
                    <p className="text-sm font-semibold text-blue-600 dark:text-blue-400">Остановить рассылку</p>
                  </div>
                  ...
                  {stopError && (
                    <p className="text-xs text-blue-500 mt-2 flex gap-1.5 items-start">
